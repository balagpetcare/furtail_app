            ...
            _FeatureGrid(
              items: [
                ...
                _FeatureItem(
                  ...
                  onTap: () =>
                      _open(context, const VaccinationTimelineScreen()),
                ),
            ...
            _FeatureGrid(
              items: [
                ...
                _FeatureItem(
                  ...
                  onTap: () =>
                      _open(context, const UpcomingVaccinationsScreen()),
                ),
                ...
                _FeatureItem(
                  ...
                  onTap: () =>
                      _open(context, const VaccinationRemindersScreen()),
                ),
                ...
                _FeatureItem(
                  ...
                  onTap: () =>
                      _open(context, const CampaignPerformanceDashboardPage()),
                ),
                ...
                _FeatureItem(
                  ...
                  onTap: () =>
                      _open(context, const CampaignGeoPreferencesPage()),
                ),
    ...
    if (!summary.hasUnlinkedRecords) {
      return Card(
        child: ListTile(
          ...
          subtitle: Text(
            '${summary.vaccinations} vaccination record(s) on file',
          ),
        ),
      );
    }
                ...
                try {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Campaign records imported'),
                      ),
                    );
                  }
                } catch (e) {
