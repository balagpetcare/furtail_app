...
final dhakaCityCorporationsProvider =
    FutureProvider<List<DhakaCityCorporation>>((ref) async {
      return ref.read(campaignRepositoryProvider).fetchDhakaCityCorporations();
    });

final dhakaBookingAreasProvider =
    FutureProvider.family<List<DhakaBookingArea>, String>((
      ref,
      corpCode,
    ) async {
      ...
      return ref
          ...
          .fetchDhakaBookingAreas(corpCode);
    });
...
final campaignLiveAnalyticsProvider =
    FutureProvider.family<CampaignLiveAnalytics, String>((ref, slug) async {
      return ref
          .read(campaignRepositoryProvider)
          .fetchCampaignAnalytics(slug: slug);
    });

final bookingTicketsProvider =
    FutureProvider.family<List<CampaignTicket>, String>((
      ref,
      bookingRef,
    ) async {
      ...
      return ref
          .read(campaignRepositoryProvider)
          .fetchBookingTickets(bookingRef);
    });
