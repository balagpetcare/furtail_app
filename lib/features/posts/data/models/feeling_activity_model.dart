...
class FeelingActivityItem {
  ...
  String get captionPrefix =>
      type == 'feeling' ? 'feeling $label' : 'activity $label';
  ...
  static const List<FeelingActivityItem> _lostRescue = [
    FeelingActivityItem(
      id: 'searching_lost',
      label: 'Searching lost pet',
      emoji: '\u{1F50E}',
      category: 'Lost & Rescue',
      type: 'activity',
    ),
    FeelingActivityItem(
      id: 'found_pet',
