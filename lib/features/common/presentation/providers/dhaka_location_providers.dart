...
class DhakaLocationsResponse {
  ...
  factory DhakaLocationsResponse.fromJson(Map<String, dynamic> j) {
    ...
    final corps = (data['corporations'] as List)
        .map((e) => DhakaCorporation.fromJson(e))
        .toList();
...
final dhakaLocationsProvider =
    FutureProvider.family<DhakaLocationsResponse, String>((ref, lang) async {
      final uri = Uri.parse(
        '${ApiConfig.host}/api/v1/locations/dhaka?lang=$lang',
      );
